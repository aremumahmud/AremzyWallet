...
function TransferModal({close, amount=0, makeTransfer}){
    ...
    return <div className="transferModal">
        {
            done?<div className="inner">
 <div style={{display:'flex', alignItems:'center',justifyContent:'space-between'}}>
             <p>Action</p>
             <FaX onClick={close} size={10} color="white" style={{padding:'.3rem', background:'red', borderRadius:'50%'}} />
        </div>
        <p style={{textAlign:'center', fontSize:'.9rem', padding:'3rem'}}>Transaction has been successfully initiated</p>
            </div>:   <form className="inner" onSubmit={validate}>
        ...
        <div className="inp">
            Amount
            <input ref={amount_init} type="number" name="amount" id="" required />
        </div>
